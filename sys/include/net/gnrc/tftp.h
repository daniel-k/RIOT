 ...
 */
typedef int (*tftp_data_callback)(uint32_t offset, void *data, size_t data_len);
 ...
 * @return -1 on failure
 */
int gnrc_tftp_client_read(ipv6_addr_t *addr, const char *file_name, tftp_data_callback data_cb, tftp_transfer_start_callback start_cb, bool use_option_extensions);
 ...
 * @return -1 on failure
 */
int gnrc_tftp_client_write(ipv6_addr_t *addr, const char *file_name, tftp_data_callback data_cb, uint32_t total_size, bool use_option_extensions);
